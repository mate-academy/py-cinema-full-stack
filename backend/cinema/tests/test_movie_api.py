...
from backend.cinema.models import Movie, MovieSession, CinemaHall, Genre, Actor
from backend.cinema.serializers import MovieListSerializer, MovieDetailSerializer
