...
from backend.cinema.models import Genre, Actor, CinemaHall, Movie, MovieSession, Order
from backend.cinema.permissions import IsAdminOrIfAuthenticatedReadOnly

from backend.cinema.serializers import (
    GenreSerializer,
    ActorSerializer,
