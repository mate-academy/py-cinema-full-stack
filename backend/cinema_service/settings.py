...
# --------------------------------------------------------------------
# CORS (modo TESTE — liberar geral para depuração do front local)
# Depois que funcionar, troque por CORS_ALLOWED_ORIGINS restrito.
# --------------------------------------------------------------------
CORS_ALLOW_ALL_ORIGINS = True          # << TESTE: libera qualquer origem
CORS_ALLOW_CREDENTIALS = False
CORS_ALLOW_HEADERS = ["*"]
CORS_ALLOW_METHODS = ["DELETE", "GET", "OPTIONS", "PATCH", "POST", "PUT"]
# Se quiser restringir depois, comente a linha acima e use:
# CORS_ALLOWED_ORIGINS = ["http://localhost:5173", "http://127.0.0.1:5173"]

# Se algum endpoint ainda redirecionar (ex.: falta de /),
# manter o CorsMiddleware no topo evita erro de preflight.
# --------------------------------------------------------------------

# Opcional: se for usar cookies/CSRF com front local (não é o caso com JWT)
