<template>
  <div v-if="active && isStaff" class="movie-container">
    ...
    <div class="container">
      ...
      <input-item label="Duration" width="wide"
                  v-model="duration"></input-item>
      <custom-multiselect label="Actors" :options="actors"
                          @option-selected="handleActorSelection"></custom-multiselect>
      <custom-multiselect label="Genres" :options="genres"
                          @option-selected="handleGenreSelection"></custom-multiselect>
