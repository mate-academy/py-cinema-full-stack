	...
	<div class="header">
		...
		<div class="action-section">
			<div class="profile-section">
				...
				<header-popup @openProfile="openProfile" @openOrders="openOrders" :class="!showPopup && 'hidden'"></header-popup>
			</div>
			<action-button @click="$emit('log-out')" type="outlined" width="small" label="Log Out"></action-button>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			hashHandler() {
				const active = location.hash.match(/#\/([a-z]*-[a-z]*|[a-z]*)/)?.[1] || 'api';
				this.activeTab = active;
				console.log('activeTab:', this.activeTab, typeof this.activeTab);
			},
